      ...
      >
        <div className="flex items-center justify-between border-b border-gray-200 dark:border-white/10 px-4 py-3">
          ...
          <button
            ...
            className="flex h-7 w-7 items-center justify-center rounded text-gray-400 dark:text-gray-500 hover:bg-gray-100 dark:hover:bg-white/10 hover:text-gray-700 dark:hover:text-white transition-colors"
          >
        ...
        <div className="border-t border-gray-200 dark:border-white/10 px-4 py-3">
          <p className="mb-1 text-xs text-gray-400 dark:text-gray-500">Storage folder</p>
          <p className="mb-2 truncate text-xs text-gray-600 dark:text-gray-300" title={favoritesDir}>{favoritesDir || '—'}</p>
          <button
            onClick={onPickDir}
